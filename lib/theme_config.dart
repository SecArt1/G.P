...
// Rename class to match main.dart usage
class ThemeConfig {
  // Light theme colors
  ...
  // Change method to static final field
  static final ThemeData lightTheme = ThemeData(
    ...
    // Remove context dependency from GoogleFonts
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        ...
        foregroundColor: MaterialStateProperty.all<Color>(_lightOnPrimaryColor),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        ...
        foregroundColor: MaterialStateProperty.all<Color>(_darkOnPrimaryColor),
        shape: MaterialStateProperty.all<RoundedRectangleBorder>(
          RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
        ),
      ),
